...
//             <DashboardCards topSales={0} totalSales={0} customers={0} orders={0} />
//             <br />
...
const id = 1;
const API_URL = "http://127.0.0.1:8000/vendor_dashboard/" + id; // Replace this with your actual API URL
    ...
    const fetchData = async () => {
      try {
        ...
        setDashboardData({
          ...
          all_product_quantity: data.all_product_quantity, // Adjusted to match your actual data key
          total_sale: data.totalSale, // Ensure this matches the actual key from your data
          last_month_sales: data.LastMonth_sales, // Corrected to match the initial state structure
        ...
        >
          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            ...
            <DashboardCards
              ...
              customers={0} // Make sure this data is included in your state if you're using it here
              orders={dashboardData.all_product_quantity ?? 0}
            />
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} sm={6}>
                <ChartCard
                  title="Monthly Sale"
                  data={dashboardData.monthly_sales} // Assuming this is structured correctly for your ChartCard component
                />
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <PieChartCard
                  title="Pie Chart"
                  data={dashboardData.all_product_quantity ?? []} // Ensure you have this data structured as needed for the PieChartCard
                />
              </Grid>
            </Grid>
          </Container>
